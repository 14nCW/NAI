...
int main() {
    ...
    auto best1 = hill_climbing(three_hump_camel_f_v, get_random_point(), get_close_points, 100000);
    std::cout << "# hill x = " << best1[0] << " " << best1[1] << std::endl;
    auto best2 = simulated_annealing(three_hump_camel_f_v, get_random_point(), get_close_points, 10000);
